...
<body class="bg-[#242424]">
    ...
    <!-- Chat List / Container -->
    <div class="chat-list max-w-4xl mx-auto p-8 pb-12 max-h-screen overflow-y-auto"></div>
        ...
        <form action="#" class="typing-form max-w-4xl mx-auto">
            <div class="input-wrapper w-full min-h-14 flex relative">
                <div class="feature-buttons absolute left-3 top-2 flex gap-2">
                    <button
                        class="feature-button flex items-center justify-center rounded-full bg-[#383838] h-10 w-10 text-text-color hover:bg-[#444] transition-colors duration-200">
