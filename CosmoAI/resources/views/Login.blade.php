...
<body class="bg-cosmo-bg text-gray-200">
    ...
    <div class="absolute top-4 left-5">
        <span class="text-xl font-semibold  flex flex-row items-center text-white"><img class="w-8 h-8 " src="{{ asset('images/white.png') }}" alt="">Cosmo</span>
    </div>
        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="space-y-5" action="#" method="POST">
                ...
                <div class="relative">
                    ...
                    <input id="password" name="password" type="password" autocomplete="current-password" required
                           ...
                           >
                    <button type="button" tabindex="-1" class="absolute inset-y-0 right-0 top-8 flex items-center px-4 text-base font-semibold text-blue-400 hover:text-blue-300 focus:outline-none transition-colors duration-150">
                        Show
                    </button>
                </div>

                <div class="pt-1">
                    <a href="#" class="text-base font-semibold text-blue-400 hover:text-blue-300 hover:underline transition-colors duration-150">
                        Forgot password?
                    </a>
                </div>
            ...
            <div class="space-y-3">
                <button type="button"
                    ...
                    <svg class="w-5 h-5 mr-2 -ml-1" viewBox="-3 0 262 262" preserveAspectRatio="xMidYMid" xmlns="http://www.w3.org/2000/svg" >
